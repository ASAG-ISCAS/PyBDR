...
from .linear_system_old import LinSysOld
...
class NonLinSysOld:
    ...
    class Entity(ContSysOld.Entity):
        ...
        def linearize_old(self, r: Geometry.Base, option):
            ...
            lin_sys = LinSysOld.Entity(xa=a)
            lin_op = LinSysOld.Option.Euclidean(
        ...
        def __abstract_err_lin(
            self, r: Geometry.Base, option: NonLinSysOld.Option.Linear
        ):
        ...
        def __abstract_err_poly(
            ...
            if option.tensor_order == 3:
                ...
                err_dyn_third = Interval.zeros(self.dim)
        ...
        def __post(self, r: [Set], option: NonLinSysOld.Option.Base):
        ...
        def reach(self, option: NonLinSysOld.Option.Base):
