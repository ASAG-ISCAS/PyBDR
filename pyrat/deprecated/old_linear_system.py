...
class LinearSystem:
    ...
    class System:
        ...
        # =============================================== private method
        # =============================================== private method
        def _tie(self, op: LinearSystem.Options):
            """
        ...
        def _exponential(self, op: LinearSystem.Options):
            """
        ...
        def _input_solution(self, op: LinearSystem.Options):
            """
        ...
        def _init_reach_euclidean(self, r_init, op: LinearSystem.Options):
            """
        ...
        def _over_reach_standard(self, op: LinearSystem.Options):
            """
        ...
        # =============================================== public method
        def init_reach(self, r_init, opt: LinearSystem.Options):
            raise NotImplementedError

        def reach_over(self, op: LinearSystem.Options):
            return self._ro_algo[op.algo](op)

        def reach_under(self, op: LinearSystem.Options):
            raise NotImplementedError
            # TODO
